...
function mu_livestream_upcoming( $atts, $content = null ) {
	...
	if ( $livestream_query->have_posts() ) {
		...
		while ( $livestream_query->have_posts() ) {
			...
			$html .= '<div class="absolute inset-0 z-10 bg-gradient-to-t from-transparent to-transparent group-hover:from-black-40 flex items-center justify-center h-full w-full">';
